...
enum Strings { // @DontAdd
	...
	HASHING, // "Hashing"
	HASHING_QUEUE_LIMIT_REACHED, // "Hashing queue limit of %1% has been reached, starting hashing now"
	...
	SETTINGS_MAX_HASHER_QUEUE, // "Maximum queue size to hash (0 = unlimited). Stop file refresh once hashing queue reaches this limit and begin hashing."
