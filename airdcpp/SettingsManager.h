...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DISCONNECT_FILESIZE, NUMBER_OF_SEGMENTS, MAX_HASH_SPEED, MAX_HASH_QUEUE, MAX_PM_HISTORY_LINES, SEARCH_ALTERNATE_COLOUR, BUNDLE_SEARCH_TIME,
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		TEXT_MYNICK_BOLD, TEXT_MYNICK_ITALIC, TEXT_FAV_BOLD, TEXT_FAV_ITALIC, TEXT_OP_BOLD, TEXT_OP_ITALIC, TEXT_URL_BOLD, TEXT_URL_ITALIC, PROGRESS_OVERRIDE_COLORS, PROGRESS_OVERRIDE_COLORS2, MENUBAR_TWO_COLORS, MENUBAR_BUMPED,
		...
		USE_PARTIAL_SHARING, POPUP_BUNDLE_DLS, POPUP_BUNDLE_ULS, LIST_HL_BOLD, LIST_HL_ITALIC, REPORT_BLOCKED_SHARE, SCAN_DL_BUNDLES, MCN_AUTODETECT, DL_AUTODETECT, UL_AUTODETECT, CHECK_USE_SKIPLIST, CHECK_IGNORE_ZERO_BYTE,
		...
		FILTER_QUEUE_INVERSED, FILTER_QUEUE_TOP, FILTER_QUEUE_RESET_CHANGE, ALWAYS_CCPM, OPEN_AUTOSEARCH, SAVE_LAST_STATE,
		BOOL_LAST };
